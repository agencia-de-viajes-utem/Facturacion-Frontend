            ...
            {isConfirmed ? (
                <div>
                    ...
                    <div className="pasajeroConfirmed">
                        <div className="d-flex flex-row gap-1 align-items-center detallePasajeroTitle my-3 mx-2">
                        <GrGroup className="mx-2" style={{ width: '3em', height: '3em' }} />
                            <p className='title-text my-auto' style={{ fontSize: '24px', fontFamily: 'Arial, sans-serif' }} >Pasajeros confirmados</p>
                        </div>
