...
export default function HomePage() {
    ...
    useEffect(() => {
        ...
        // Set the 'token' state variable with the retrieved value
        if (tokenParam) {
            setToken(tokenParam);
        }
    }, []);
    ...
    const apiUrl = import.meta.env.VITE_BACK_FACTURACION;
    ...
    const handleAcceptModal = () => {
        ...
        if (metodoDePagoSeleccionado === 'webpay') {
            window.location.href = `${import.meta.env.VITE_BACK_FACTURACION}`;
